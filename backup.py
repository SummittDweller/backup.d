...
def main(argv):
  ...
  try:
    opts, args = getopt.getopt(argv, "hfc:", ["--files", "configFile="])
  except getopt.GetoptError:
    print 'backup.py -c <configFile> --files'
    sys.exit(2)
  for opt, arg in opts:
    if opt == '-h':
      print 'backup.py -c <configFile> --files'
      ...
      getFiles = True
  print 'Config file for backup is ', configFile
...
# Function lifted from https://wiki.python.org/moin/ConfigParserExamples
